...
exports.default = {
	...
	mounted: function mounted() {
		...
		this._animateLayer({ name: 'skills', end: 360, duration: 600 }, function () {
			_this._animateLayer({ name: 'tSkills', opacity: 1, duration: 300 }, function () {
				_this._animateLayer({ name: 'js', end: 360, duration: 600 }, function () {
					_this._animateLayer({ name: 'tJs', opacity: 1, duration: 300 });
					_this._drawLine({ name: 'skillsToJS', x: 500, y: 320 })._animateLayer({ name: 'skillsToJS', x: 500, y: 270 });
					_this._animateLayer({ name: 'node', end: 360, duration: 600 }, function () {
						_this._animateLayer({ name: 'tNode', opacity: 1, duration: 300 });
						_this._drawLine({ name: 'JStoNode', x: 430, y: 200 })._animateLayer({ name: 'JStoNode', x: 350, y: 200 });
					});
					_this._animateLayer({ name: 'vue', end: 360, duration: 600 }, function () {
						_this._animateLayer({ name: 'tVue', opacity: 1, duration: 300 });
						_this._drawLine({ name: 'JStoVue', x: 570, y: 200 })._animateLayer({ name: 'JStoVue', x: 650, y: 200 });
					});
					_this._animateLayer({ name: 'socket', end: 360, duration: 600 }, function () {
						_this._animateLayer({ name: 'tSocket', opacity: 1, duration: 300 });
						_this._drawLine({ name: 'JStoSocket', x: 500, y: 130 })._animateLayer({ name: 'JStoSocket', x: 500, y: 110 });
					});
				});
				_this._animateLayer({ name: 'PHP', end: 360, duration: 600 }, function () {
					_this._animateLayer({ name: 'tPHP', opacity: 1, duration: 300 });
					_this._drawLine({ name: 'skillsToPHP', x: 530, y: 350 })._animateLayer({ name: 'skillsToPHP', x: 580, y: 350 });
					_this._animateLayer({ name: 'symfony', end: 360, duration: 600 }, function () {
						_this._animateLayer({ name: 'tSymfony', opacity: 1, duration: 300 });
						_this._drawLine({ name: 'PHPtoSymfony', x: 720, y: 350 })._animateLayer({ name: 'PHPtoSymfony', x: 800, y: 350 });
					});
				});

				_this._animateLayer({ name: 'mobile', end: 360, duration: 600 }, function () {
					_this._animateLayer({ name: 'tMobile', opacity: 1, duration: 300 });
					_this._drawLine({ name: 'skillsToMobile', x: 500, y: 380 })._animateLayer({ name: 'skillsToMobile', x: 500, y: 430 });

					_this._animateLayer({ name: 'java', end: 360, duration: 600 }, function () {
						_this._animateLayer({ name: 'tJava', opacity: 1, duration: 300 });
						_this._drawLine({ name: 'mobileToJava', x: 430, y: 500 })._animateLayer({ name: 'mobileToJava', x: 350, y: 500 });
					});

					_this._animateLayer({ name: 'kotlin', end: 360, duration: 600 }, function () {
						_this._animateLayer({ name: 'tKotlin', opacity: 1, duration: 300 });
						_this._drawLine({ name: 'mobileToKotlin', x: 570, y: 500 })._animateLayer({ name: 'mobileToKotlin', x: 650, y: 500 });
					});
				});
				_this._animateLayer({ name: 'CSS', end: 360, duration: 600 }, function () {
					_this._animateLayer({ name: 'tCSS', opacity: 1, duration: 300 });
					_this._drawLine({ name: 'skillsToCSS', x: 470, y: 350 })._animateLayer({ name: 'skillsToCSS', x: 420, y: 350 });
					_this._animateLayer({ name: 'foundation', end: 360, duration: 600 }, function () {
						_this._animateLayer({ name: 'tFoundation', opacity: 1, duration: 300 });
						_this._drawLine({ name: 'CSStoFoundation', x: 280, y: 350 })._animateLayer({ name: 'CSStoFoundation', x: 200, y: 350 });
					});
				});
			});
		});
	...
	methods: {
		_drawLine: function _drawLine(options) {
		...
		_animateLayer: function _animateLayer(options) {
			...
			var name = options.name,
			    ...
			    animation = opacity ? { opacity: opacity } : end ? { end: end } : {
				x2: x,
				y2: y
			};

			this.$canvas.animateLayer(name, animation, duration, function (layer) {
				if (callback) return callback(layer);
			});
		},
		_drawText: function _drawText(options) {
		...
		_drawArc: function _drawArc(options) {
			var opacity = options.opacity,
			    x = options.x,
			    y = options.y,
			    name = options.name,
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"about"},[_vm._m(0),_c('canvas',{ref:"canvas",attrs:{"data-depth":"0.6","width":"1000","height":"700"}}),_c('video',{staticClass:"background",attrs:{"data-depth":"0.2","preload":"auto","loop":"loop","autoplay":"true","src":"/video/bg.mp4"}})])}
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"content"},[_c('div',{staticClass:"content__container"},[_c('p',{staticClass:"content__container__text"},[_vm._v("I'm")]),_c('ul',{staticClass:"content__container__list"},[_c('li',{staticClass:"content__container__list__item"},[_vm._v("Alexia")]),_c('li',{staticClass:"content__container__list__item"},[_vm._v("creative")]),_c('li',{staticClass:"content__container__list__item"},[_vm._v("hard-working")]),_c('li',{staticClass:"content__container__list__item"},[_vm._v("determined")])])])])}]
__vue__options__._scopeId = "data-v-320d2ac3"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-320d2ac3", __vue__options__)
  } else {
    hotAPI.reload("data-v-320d2ac3", __vue__options__)
  }
})()}
},{"jcanvas":7,"jquery":8,"vue":12,"vue-hot-reload-api":10}],2:[function(require,module,exports){
;(function(){
'use strict';
...
var _index = require('../navigation/index.vue');
...
exports.default = {
	name: 'app',
	components: { Navigation: _index2.default }
};
})()
if (module.exports.__esModule) module.exports = module.exports.default
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"app"},[_c('navigation'),_c('router-view')],1)}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-07129b52", __vue__options__)
  } else {
    hotAPI.reload("data-v-07129b52", __vue__options__)
  }
})()}
},{"../navigation/index.vue":5,"vue":12,"vue-hot-reload-api":10}],3:[function(require,module,exports){
;(function(){
'use strict';
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        this._drawImage({ source: '/image/silhouette.png' })._drawLine({ name: 'line', x: 280, y: 100 })._drawText({
            opacity: 0,
            x: 400,
            y: 35,
            text: 'Hard-working',
    ...
    methods: {
        _drawImage: function _drawImage(options) {
        ...
        _animateLayer: function _animateLayer(options) {
            ...
            var name = options.name,
                ...
                opacity = options.opacity,
                duration = options.duration,
                animation = opacity ? { opacity: opacity } : { x2: x, y2: y };
        ...
        _playAnimation: function _playAnimation() {
            ...
            this._animateLayer({
                ...
                _this._drawLine({ name: 'line2', x: 300, y: 50 })._animateLayer({
                    name: 'line2',
                    x: 500,
                    y: 50,
                    duration: 300
                }, function () {
                    _this._animateLayer({ name: 'text', opacity: 1, duration: 300 }, function () {
                        _this._drawLine({ name: 'line3', x: 160, y: 140 })._animateLayer({
                            name: 'line3',
                            x: 125,
                            y: 90,
                            duration: 300
                        }, function () {
                            _this._drawLine({ name: 'line4', x: 125, y: 90 })._animateLayer({
                                name: 'line4',
                                x: 0,
                                y: 90,
                                duration: 300
                            }, function () {
                                _this._animateLayer({ name: 'text2', opacity: 1, duration: 300 }, function () {
                                    _this._drawLine({ name: 'line5', x: 190, y: 420 })._animateLayer({
                                        name: 'line5',
                                        x: 220,
                                        y: 460,
                                        duration: 300
                                    }, function () {
                                        _this._drawLine({ name: 'line6', x: 220, y: 460 })._animateLayer({
                                            name: 'line6',
                                            x: 400,
                                            y: 460,
                                            duration: 300
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"home"},[_c('canvas',{ref:"canvas",attrs:{"data-depth":"0.6","width":"500","height":"500"}}),_c('video',{staticClass:"background",attrs:{"data-depth":"0.2","preload":"auto","loop":"loop","autoplay":"true","src":"/video/bg.mp4"}})])}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-2b289294"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2b289294", __vue__options__)
  } else {
    hotAPI.reload("data-v-2b289294", __vue__options__)
  }
})()}
},{"jcanvas":7,"jquery":8,"vue":12,"vue-hot-reload-api":10}],4:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"home"},[_c('div',{attrs:{"id":"scene"}},[_c('div',{staticClass:"motto stay",attrs:{"data-depth":"0.4"}},[_vm._v("STAY")]),_c('div',{staticClass:"motto determined",attrs:{"data-depth":"0.4"}},[_vm._v("DETERMINED")]),_c('canvas',{ref:"canvas",attrs:{"data-depth":"0.6","width":"500","height":"500"}}),_c('video',{staticClass:"background",attrs:{"data-depth":"0.2","preload":"auto","loop":"loop","autoplay":"true","src":"/video/bg.mp4"}})])])}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-663d0cc5"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-663d0cc5", __vue__options__)
  } else {
    hotAPI.reload("data-v-663d0cc5", __vue__options__)
  }
})()}
},{"jcanvas":7,"jquery":8,"vue":12,"vue-hot-reload-api":10}],5:[function(require,module,exports){
;(function(){
'use strict';
...
exports.default = {
				...
				mounted: function mounted() {
								...
								this.$menu.on('mousedown touchstart', function () {
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"navigation"},[_c('div',{ref:"menu",staticClass:"radial-menu"},[_c('span',{ref:"aboutSpan"},[_c('a',{ref:"aboutLink"},[_c('div',{staticClass:"menu-item1",class:{ open: _vm.open }},[_c('i',{ref:"aboutIcon",staticClass:"fal fa-user"})])])]),_c('span',{ref:"graduationSpan"},[_c('a',{ref:"graduationLink"},[_c('div',{staticClass:"menu-item2",class:{ open: _vm.open }},[_c('i',{ref:"graduationIcon",staticClass:"fal fa-graduation-cap"})])])]),_c('span',{ref:"portfolioSpan"},[_c('a',{ref:"portfolioLink"},[_c('div',{staticClass:"menu-item3",class:{ open: _vm.open }},[_c('i',{ref:"portfolioIcon",staticClass:"fal fa-code"})])])]),_c('span',{attrs:{"title":"Contact"}},[_c('div',{staticClass:"menu-item4",class:{ open: _vm.open },attrs:{"data-open":"modal"}},[_c('i',{staticClass:"fal fa-envelope"})])]),_c('div',{staticClass:"mask"},[_c('i',{ref:"mask",staticClass:"fal fa-home"})])])])}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-3593b1ba"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3593b1ba", __vue__options__)
  } else {
    hotAPI.reload("data-v-3593b1ba", __vue__options__)
  }
})()}
},{"jquery":8,"vue":12,"vue-hot-reload-api":10}],6:[function(require,module,exports){
;(function(){
'use strict';
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"home"},[_c('canvas',{ref:"canvas",attrs:{"data-depth":"0.6","width":"500","height":"500"}}),_c('video',{staticClass:"background",attrs:{"data-depth":"0.2","preload":"auto","loop":"loop","autoplay":"true","src":"/video/bg.mp4"}})])}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-cab1aa84"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-cab1aa84", __vue__options__)
  } else {
    hotAPI.reload("data-v-cab1aa84", __vue__options__)
  }
})()}
},{"jcanvas":7,"jquery":8,"vue":12,"vue-hot-reload-api":10}],7:[function(require,module,exports){
/**
...
var Application = function Application() {
    ...
    var router = new Router({
        mode: 'history',
        routes: [{ path: '/', component: Home }, { path: '/about', component: About }, { path: '/graduation', component: Graduation }, { path: '/portfolio', component: Portfolio }]
    });
    this.app = new Vue({
        router: router,
...
},{"../../components/about/index.vue":1,"../../components/app/index.vue":2,"../../components/graduation/index.vue":3,"../../components/home/index.vue":4,"../../components/portfolio/index.vue":6,"vue":12,"vue-router":11}]},{},[13]);
