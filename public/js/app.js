	...
	mounted: function mounted() {
		...
		this._animateLayer({ name: 'skills', end: 360, duration: 600 }, function () {
			_this._animateLayer({ name: 'tSkills', opacity: 1, duration: 300 }, function () {
				_this._drawLine({ name: 'skillsToJS', x: 930, y: 700 })._animateLayer({ name: 'skillsToJS', x: 800, y: 700 });
				_this._drawLine({ name: 'skillsToCSS', x: 950, y: 650 })._animateLayer({ name: 'skillsToCSS', x: 863, y: 563 });
				_this._drawLine({ name: 'skillsToSEO', x: 1050, y: 650 })._animateLayer({ name: 'skillsToSEO', x: 1152, y: 556 });
				_this._drawLine({ name: 'skillsToPHP', x: 1070, y: 700 })._animateLayer({ name: 'skillsToPHP', x: 1200, y: 700 });
				_this._drawLine({ name: 'skillsToCsharp', x: 950, y: 750 })._animateLayer({ name: 'skillsToCsharp', x: 850, y: 850 });
				_this._drawLine({ name: 'skillsToMobile', x: 1050, y: 750 })._animateLayer({ name: 'skillsToMobile', x: 1132, y: 832 });
				...
				_this._animateLayer({ name: 'Csharp', end: 360, duration: 600 }, function () {
					_this._animateLayer({ name: 'tCsharp', opacity: 1, duration: 300 });
					_this._drawLine({ name: 'CsharpToUnity', x: 730, y: 900 })._animateLayer({ name: 'CsharpToUnity', x: 650, y: 900 });
					_this._animateLayer({ name: 'unity', end: 360, duration: 600 }, function () {
						_this._animateLayer({ name: 'tUnity', opacity: 1, duration: 300 });
					});
				});
				_this._animateLayer({ name: 'mobile', end: 360, duration: 600 }, function () {
					_this._animateLayer({ name: 'tMobile', opacity: 1, duration: 300 });
					_this._drawLine({ name: 'mobileToJava', x: 1295, y: 900 })._animateLayer({ name: 'mobileToJava', x: 1350, y: 900 });
					_this._animateLayer({ name: 'java', end: 360, duration: 600 }, function () {
						_this._animateLayer({ name: 'tJava', opacity: 1, duration: 300 });
					});
					_this._drawLine({ name: 'mobileToKotlin', x: 1280, y: 850 })._animateLayer({ name: 'mobileToKotlin', x: 1380, y: 755 });
					_this._animateLayer({ name: 'kotlin', end: 360, duration: 600 }, function () {
						_this._animateLayer({ name: 'tKotlin', opacity: 1, duration: 300 });
					});
				});
				_this._animateLayer({ name: 'SEO', end: 360, duration: 600 }, function () {
					_this._animateLayer({ name: 'tSEO', opacity: 1, duration: 300 });
					_this._drawLine({ name: 'SEOtoBacklink', x: 1275, y: 500 })._animateLayer({ name: 'SEOtoBacklink', x: 1380, y: 500 });
					_this._animateLayer({ name: 'backlink', end: 360, duration: 600 }, function () {
						_this._animateLayer({ name: 'tBacklink', opacity: 1, duration: 300 });
					});
				});
				_this._animateLayer({ name: 'CSS', end: 360, duration: 600 }, function () {
					_this._animateLayer({ name: 'tCSS', opacity: 1, duration: 300 });
					_this._drawLine({ name: 'CSStoFoundation', x: 710, y: 500 })._animateLayer({ name: 'CSStoFoundation', x: 600, y: 500 });
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"about"},[_c('canvas',{ref:"canvas",attrs:{"data-depth":"0.6","width":"1920","height":"1080"},on:{"click":_vm.getCoords}}),_c('video',{staticClass:"background",attrs:{"data-depth":"0.2","preload":"auto","loop":"loop","autoplay":"true","src":"/video/bg.mp4"}}),_c('img',{attrs:{"src":"image/me.png"}})])}
...
},{"jcanvas":5,"jquery":6,"vue":14,"vue-hot-reload-api":12}],2:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../navigation/index.vue":4,"vue":14,"vue-hot-reload-api":12}],3:[function(require,module,exports){
;(function(){
'use strict';
...
var Parallax = require('../../node_modules/parallax-js/dist/parallax.js');
...
},{"../../node_modules/parallax-js/dist/parallax.js":8,"jcanvas":5,"jquery":6,"vue":14,"vue-hot-reload-api":12}],4:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"navigation"},[_c('div',{ref:"menu",staticClass:"radial-menu"},[_c('div',{staticClass:"menu-item1",class:{ open: _vm.open }},[_c('i',{staticClass:"fal fa-user"})]),_c('div',{staticClass:"menu-item2",class:{ open: _vm.open }},[_c('i',{staticClass:"fal fa-graduation-cap"})]),_c('div',{staticClass:"menu-item3",class:{ open: _vm.open }},[_c('i',{staticClass:"fal fa-code"})]),_c('div',{staticClass:"menu-item4",class:{ open: _vm.open },attrs:{"data-open":"modal"}},[_c('i',{staticClass:"fal fa-envelope"})]),_vm._m(0)])])}
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"mask"},[_c('i',{staticClass:"fal fa-home"})])}]
...
},{"jquery":6,"vue":14,"vue-hot-reload-api":12}],5:[function(require,module,exports){
/**
          ...
          switch (value) {
            ...
            case '3D':
              if (propertySupport) {
                ...
                element.style[jsProperty] = 'scale(1.1) translate3d(1px,1px,1px)';
      ...
      var Parallax = function () {
        ...
        _createClass(Parallax, [{
          ...
          value: function setPosition(element, x, y) {
            ...
            if (this.transform3DSupport) {
              helpers.css(element, 'transform', 'scale(1.1) translate3d(' + x + ',' + y + ',0)');
            } else if (this.transform2DSupport) {
              helpers.css(element, 'transform', 'scale(1.1) translate(' + x + ',' + y + ')');
            } else {
...
},{"_process":10,"object-assign":7,"performance-now":9,"raf":11}],9:[function(require,module,exports){
(function (process){
// Generated by CoffeeScript 1.12.2
(function() {
  var getNanoSeconds, hrtime, loadTime, moduleLoadTime, nodeLoadTime, upTime;
...
},{"../../components/about/index.vue":1,"../../components/app/index.vue":2,"../../components/home/index.vue":3,"vue":14,"vue-router":13}]},{},[15]);
